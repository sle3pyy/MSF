...
print("A diferença em amplitude de wF=1 e wF=0.5 é tão alta porque w0 = sqrt(k/m) = 0.5, logo a ressonância dá-se para w=0.5, sendo a amplitude muito maior para w=0.5 que para qualquer outro valor.")